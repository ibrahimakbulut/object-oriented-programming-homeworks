class composedShape
!!!134410.cpp!!!	getter_container_shape() : Shape
	return container_shape;
!!!134538.cpp!!!	getter_inner_shape() : Shape
	return inner_shape;
!!!134666.cpp!!!	setter_container_shape(in Container_shape : PolygonDyn) : void
		container_shape=Container_shape;
!!!134794.cpp!!!	setter_inner_shape(in innerr_shape : PolygonDyn) : void
		inner_shape=innerr_shape;
!!!134282.cpp!!!	getter_inner_shapes_vector() : vector<Shape*>
	return inner_shapes_vector;
!!!133130.cpp!!!	~composedShape()
  //polygondyn objects were not created as dynamic so dont need to delete manuel;

	for(int i=0;i<inner_shapes_vector.size();++i){
		delete inner_shapes_vector[i];
	}
!!!132746.cpp!!!	composedShape(in copy_composed : composedShape)
...
!!!132874.cpp!!!	operator =(in rtSide : composedShape) : composedShape
	if(this==&rtSide)
		return *this;
...
!!!131594.cpp!!!	composedShape(in Container_shape : Rectangle, in inner_small_shape : Rectangle)
 //constructor with rectangle parameters
...
!!!131722.cpp!!!	composedShape(in Container_shape : Rectangle, in inner_small_shape : Triangle)
 //constructor with rectangle and triangle parameter

PolygonDyn temp_Object(Container_shape);
PolygonDyn temp_Object1(inner_small_shape);
container_shape=temp_Object;
inner_shape=temp_Object1;
!!!131850.cpp!!!	composedShape(in Container_shape : Rectangle, in inner_small_shape : Circle)
 //constructor with rectangle and circle parameter
	
PolygonDyn temp_Object(Container_shape);
PolygonDyn temp_Object1(inner_small_shape);
container_shape=temp_Object;
inner_shape=temp_Object1;
!!!131978.cpp!!!	composedShape(in Container_shape : Triangle, in inner_small_shape : Rectangle)
 //constructor with triangle and rectangle parameters 
	
PolygonDyn temp_Object(Container_shape);
PolygonDyn temp_Object1(inner_small_shape);
container_shape=temp_Object;
inner_shape=temp_Object1;
!!!132106.cpp!!!	composedShape(in Container_shape : Triangle, in inner_small_shape : Triangle)
 //constructors with triangles parameters
	
PolygonDyn temp_Object(Container_shape);
PolygonDyn temp_Object1(inner_small_shape);
container_shape=temp_Object;
inner_shape=temp_Object1;
!!!132234.cpp!!!	composedShape(in Container_shape : Triangle, in inner_small_shape : Circle)
 //constructor with triangle container and circle inner parameter
	
PolygonDyn temp_Object(Container_shape);
PolygonDyn temp_Object1(inner_small_shape);
container_shape=temp_Object;
inner_shape=temp_Object1;
!!!132362.cpp!!!	composedShape(in Container_shape : Circle, in inner_small_shape : Rectangle)
//constructor with circle container and rectangle inner parameter
	
PolygonDyn temp_Object(Container_shape);
PolygonDyn temp_Object1(inner_small_shape);
container_shape=temp_Object;
inner_shape=temp_Object1;
!!!132490.cpp!!!	composedShape(in Container_shape : Circle, in inner_small_shape : Triangle)
//constructor with circle container and triangle inner parameter

PolygonDyn temp_Object(Container_shape);
PolygonDyn temp_Object1(inner_small_shape);
container_shape=temp_Object;
inner_shape=temp_Object1;
!!!132618.cpp!!!	composedShape(in Container_shape : Circle, in inner_small_shape : Circle)
//constructor with circle container and circle inner parameter 

PolygonDyn temp_Object(Container_shape);
PolygonDyn temp_Object1(inner_small_shape);
container_shape=temp_Object;
inner_shape=temp_Object1;
!!!133002.cpp!!!	composedShape()
 //otomatically PolygonDyn objects created by their no parameter constructor and inside PolygonDyn objects
								//polygon_points point to nullptr ,size_of_polygon points equal 0.
	
!!!134922.cpp!!!	operator +=(inout shape : Shape) : composedShape
 //this operator overload adds a shape as Polygon to composedShape object.
	inner_shapes_vector.push_back(&shape);
	return *this;
!!!135050.cpp!!!	operator [](in index : uint) : Shape
 //with this operator an element of vector is only accessable, not changeable
...
!!!135178.cpp!!!	operator [](in index : uint) : Shape
 //with this operator an element of vector is  accessable and  changeable
	if(inner_shapes_vector.size()==0){
		cout<<"vector is empty, can not be reached an element of it"<<endl;
		Shape* b=nullptr; //if vector is empty then return a shape element that has null as void pointer variable.
		return b;
	...
	return inner_shapes_vector[index];
!!!134026.cpp!!!	print_shape(inout outputfile : ofstream) : ofstream
 //for writing a composedshape 
